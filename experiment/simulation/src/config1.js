...
+'<div class="row">'
	   ...
	   +'<option value="50" >3 sq cm </option>'
	   +'<option value="55">5 sq cm</option>'
	   +'<option value="60">7 sq cm</option>'
	   +'</select>'
	   +'</div>'
	   +'</div>'
...
CalculateActualFlowStr +='<div class="col-sm-4">'
				       +'<label  id=""  class="" style="font-size:16px;margin:15px 10px ;"> Calculate the radius of cylinder(sq cm):  </label>'
				       +'</div>'
					 +'<div class="col-sm-4">'
